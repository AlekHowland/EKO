    ...
    public void cargarTexturas() {
        switch (assets){
            ...
            case "Tortuga":
                ...
                animacionAgachado = new Animation(0.075f, texturaPAgachado[0][0],texturaPAgachado[0][1], texturaPAgachado[0][2], texturaPAgachado[0][3],texturaPAgachado[0][4],texturaPAgachado[0][5], texturaPAgachado[0][6], texturaPAgachado[0][7]);
                break;
